...
The long-term goal is to combine catalogues, sky geometry, telemetry, weather and atmospheric quality, trajectory feasibility, and multi-facility coordination. The formal current release is **V2.1 (full version 2.1.20260924)**; it sends no device commands and does not replace schedulers, operators, or safety interlocks.
